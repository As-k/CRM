...
public class ChipExamplesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // chip 1
        mChip1.setOnChipClicked(new View.OnClickListener() {
            @Override
        ...
        mChip1.setOnDeleteClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 2
        mChip2.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 3
        mChip3.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mChip3.setOnDeleteClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 4
        mChip4.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mChip4.setOnDeleteClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 5
        mChip5.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 6
        mChip6.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mChip6.setOnDeleteClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        // chip 7
        mChip7.setOnChipClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mChip7.setOnDeleteClicked(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
